...
const features = [
  {
    icon: <FaRegMoneyBillAlt className="text-2xl text-red-500" />,
  ...
  {
    icon: <FaRegCalendarCheck className="text-2xl text-red-500" />,
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {features.map((item, i) => (
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 text-gray-800 dark:text-white shadow-lg rounded-xl p-6 hover:shadow-2xl transition duration-300"
          >
            <div className="w-14 h-14 flex items-center justify-center bg-red-100 rounded-full mb-4">
              {item.icon}
            </div>
            <h3 className="font-bold text-md md:text-lg">{item.title}</h3>
