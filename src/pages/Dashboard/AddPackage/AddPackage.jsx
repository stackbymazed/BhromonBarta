...
const AddPackage = () => {
    ...
    return (
        <div className="max-w-3xl mx-auto mt-8 p-6 bg-white rounded shadow">
            <h2 className="text-2xl font-bold mb-4 text-center dark:text-black">Add New Tour Package</h2>

            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 dark:text-black">
                ...
                <div>
                    ...
                    {galleryFields.map((item, index) => (
                        <div key={item.id} className="flex gap-2 mb-2">
                            ...
                            <button
                                ...
                                className="bg-red-500 text-white px-2 rounded dark:text-black"
                            >
                                X
                            </button>
                        </div>
                    ...
                    <button
                        ...
                        className="bg-blue-500 text-white px-3 py-1 rounded dark:text-black"
                    >
                        + Add Image
                    </button>
                </div>
