        ...
        <div className="">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-gray-900 p-5 rounded-xl shadow-md">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
                A simple and effective way to learn together with classmates. Join study groups, share notes, participate in live discussions, and prepare for exams more efficiently
              </p>
              <div className="flex justify-between text-sm">
                <a
                  href="https://github.com/stackbymazed/Online-Group-Study-Client"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-blue-600 hover:underline"
                >
                ...
                <a
                  href="https://assignment-11-e732e.web.app/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-green-600 hover:underline"
                >
            ...
            <div className="bg-white dark:bg-gray-900 p-5 rounded-xl shadow-md">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
                Find a trustworthy and compatible roommate quickly. Match based on budget, location, and lifestyle to find the perfect living companion.
              </p>
              <div className="flex justify-between text-sm">
                <a
                  href="https://github.com/stackbymazed/Roommate-Finder-Client"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-blue-600 hover:underline"
                >
                ...
                <a
                  href="https://roommate-finder-5dc65.web.app/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-green-600 hover:underline"
                >
